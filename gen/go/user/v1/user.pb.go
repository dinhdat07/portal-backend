...
const file_user_v1_user_proto_rawDesc = "" +
	"\n" +
	"\x12user/v1/user.proto\x12\x0eportal.user.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x16common/v1/common.proto\"\x15\n" +
	"\x13GetMyProfileRequest\"\xc8\x01\n" +
	...
	"\busername\x18\x03 \x01(\tH\x02R\busername\x88\x01\x01\x12\x15\n" +
	"\x03dob\x18\x04 \x01(\tH\x03R\x03dob\x88\x01\x01B\r\n" +
	"\v_first_nameB\f\n" +
	"\n" +
	"_last_nameB\v\n" +
	"\t_usernameB\x06\n" +
	...
	"\x14confirm_new_password\x18\x03 \x01(\tR\x12confirmNewPassword2\xf2\x02\n" +
	"\vUserService\x12e\n" +
