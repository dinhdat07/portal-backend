...
const file_admin_v1_admin_proto_rawDesc = "" +
	"\n" +
	"\x14admin/v1/admin.proto\x12\x0fportal.admin.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x16common/v1/common.proto\"\x92\x03\n" +
	...
	"\tfull_name\x18\x05 \x01(\tH\x02R\bfullName\x88\x01\x01\x12\x15\n" +
	"\x03dob\x18\x06 \x01(\tH\x03R\x03dob\x88\x01\x01\x123\n" +
	"\x04role\x18\a \x01(\x0e2\x1a.portal.common.v1.RoleCodeH\x04R\x04role\x88\x01\x01\x129\n" +
	"\x06status\x18\b \x01(\x0e2\x1c.portal.common.v1.UserStatusH\x05R\x06status\x88\x01\x01\x12'\n" +
	...
	"\x04meta\x18\x02 \x01(\v2 .portal.common.v1.PaginationMetaR\x04meta\"\xc3\x01\n" +
	...
	"\x04role\x18\x06 \x01(\x0e2\x1a.portal.common.v1.RoleCodeR\x04role\"/\n" +
	...
	"\busername\x18\x04 \x01(\tH\x02R\busername\x88\x01\x01\x12\x15\n" +
	"\x03dob\x18\x05 \x01(\tH\x03R\x03dob\x88\x01\x01B\r\n" +
	"\v_first_nameB\f\n" +
	"\n" +
	"_last_nameB\v\n" +
	"\t_usernameB\x06\n" +
	...
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12.\n" +
	"\x04role\x18\x02 \x01(\x0e2\x1a.portal.common.v1.RoleCodeR\x04role2\xcb\x06\n" +
	"\fAdminService\x12o\n" +
